      ...
      <div className="w-full relative min-h-screen font-['Helvetica_Now_Display']">
        ...
        <div className="w-full relative z-[1] h-screen ">
          <nav className="w-full p-8 flex justify-between z-50">
            <div className="brand text-2xl font-md">ThirtySixStudioWebClone</div>
          ...
          <div className="w-full absolute">
            <h1
              ref={headingref}
              className="text-[12rem] font-normal tracking-tight leading-none pl-16 mt-32 mx-auto text-center mb-40"
            >
              Thirtysixstudio
            </h1>
          </div>
